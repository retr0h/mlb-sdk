...
The mlb-sdk project has strict rules for AI usage:
...
- **Bad AI drivers will be denounced.** People who produce bad contributions
  that are clearly AI (slop) will be added to our public denouncement list. This
  list will block all future contributions. Additionally, the list is public and
  may be used by other projects to be aware of bad actors. We love to help
  junior developers learn and grow, but if you're interested in that then don't
  use AI, and we'll help you. I'm sorry that bad AI drivers have ruined this for
  you.

These rules apply only to outside contributions to mlb-sdk. Maintainers are
...
Please remember that mlb-sdk is maintained by humans.
...
mlb-sdk is written with plenty of AI assistance, and many maintainers embrace AI
